...
export const contactSchema = z.object({
  ...
  message: z.string().trim().min(20, "A few sentences, please — at least 20 characters."),
});
    ...
    >
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)]">
        <Card className="flex flex-col gap-5 p-6 sm:p-8">
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Say hi — the human way.</h3>
          ...
          <ul className="text-foreground/85 mt-4 grid gap-3 text-sm">
            <li>
              <span className="text-muted-foreground">Best for:</span> Senior / Staff Backend &
              Platform roles, scalability consulting.
            </li>
            <li>
        ...
        {featureFlags.showContactForm ? (
          ...
          <Card className="p-6 sm:p-8">
            ...
            <p className="text-muted-foreground mt-3 text-sm">
              Please use email or LinkedIn to reach out. I usually reply within 48 hours.
            </p>
